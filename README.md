...
JWT_SECRET="generate-a-secure-random-secret-at-least-32-characters-long"
JWT_EXPIRATION="7d"
...
- Usa servicios administrados para la base de datos (AWS RDS, Railway, Supabase, etc.)
- Considera usar servicios como Vercel (frontend) y Railway/Render (backend)
...
**Desarrollado con ❤️ para NoCountry**
